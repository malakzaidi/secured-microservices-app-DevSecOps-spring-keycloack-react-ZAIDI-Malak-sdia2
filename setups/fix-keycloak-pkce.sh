...
echo "🔧 Correction de la configuration PKCE du client Keycloak..."
...
# Mettre à jour le client pour activer PKCE
echo "🔧 Activation de PKCE pour le client..."
...
echo "✅ Configuration PKCE activée avec succès !"
echo ""
